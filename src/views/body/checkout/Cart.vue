        ...
        <div class="col-main">
            ...
            <div v-if="pageInitComplete && cart_products && isCartInfoNotEmpty(cart_products)" class="product_page"  >        
                ...
                <div class="cart">
                    ...
                    <div class="cart-collaterals">
                        <div class="col2-set" v-if="show_coupon">
                            <div class="col-1">
                            </div>
                            <div class="col-2">
                        ...
                        <div class="totals cart-totals">
                            <div class="proceed_to_checkout">
                                <div class="row no-gutter">
                                    ...
                                    <div v-if="show_paypal_button" class="col-50">
            ...
            <div v-if="pageInitComplete && (!cart_products)" class="empty_cart ">
                <div id="empty_cart_info">
                    {{ $t("message.your_shopping_cart_is_empty") }}
                    <router-link to="/"  class="">
                        {{ $t("message.start_shopping_now") }}!
                    </router-link>
                    <br>
                    ...
                    {{ $t("message.please") }}
                        <router-link to="/customer/account/login"  class="">
                            ...
                            {{ $t("message.log_in_account") }}
                        </router-link>
                    {{ $t("message.to_view_the_products_you_have_previously_added_to_your_shopping_cart") }}
                    .
                </div>
            </div> 
            ...
            $.ajax({
                ...
                success:function(reponseData, textStatus,request){
                    ...
                    if(reponseData.code == 200){
                        ...
                        $.toast(self.$i18n.t("message.get_paypal_express_token_fail"));
                    }else{
                        $.toast(self.$i18n.t("message.generate_order_fail"));
                    }
                    self.saveReponseHeader(request); 
            ...
            $.ajax({
                ...
                success:function(reponseData, textStatus,request){
                    ...
                    if(reponseData.code == 200){
                        ...
                        $.toast(self.$i18n.t("message.update_qty_fail"));
                    }
            ...
            $.ajax({
                ...
                success:function(reponseData, textStatus,request){
                    ...
                    if(reponseData.code == 200){
                        ...
                        $.toast(self.$i18n.t("message.select_cart_product_fail"));
                    }
