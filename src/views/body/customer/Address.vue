<template>
    <div class="main container one-column content customer_address_list">
        <div class="col-main " >
            ...
            <div class="account_customer_address" id="billing_address" v-for="(address, index) in address_list">	
                <ul>
                    <li>
                        <div>
                            <p>
                                {{address.first_name}} {{address.last_name}}
                                <router-link :to="'/customer/address/edit/' + address.address_id" class="edit_shipping">
                        ...
                        <div class="select_address">
                            ...
                            <br/>
                            <a class="remove_address" href="javascript:void(0)" @click="removeAddress(address.address_id)">
            ...
            <div>
                <router-link to="/customer/address/edit/0" class="add_new_shipping">
            ...
            $.ajax({
                ...
                success:function(reponseData, textStatus,request){
                    ...
                    if(reponseData.code == 1100003){
                       ...
                       //$.toast(self.$i18n.t("message.change_default_address_success"));
                       location.reload() ; 
                    }
                },
                error:function(){
