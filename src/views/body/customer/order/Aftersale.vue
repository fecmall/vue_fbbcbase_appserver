                                ...
                                <table summary="Items Ordered" id="my-orders-table" class="data-table">
                                    ...
                                    <thead>
                                        <tr class="first last">
                                            ...
                                            <th class="a-center">{{ $t("message.request_receive") }}</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                    ...
                                    <tbody class="odd">
                                        ...
                                        <tr v-for="(itemProduct,index) in orderProducts" id="order-item-row" class="border first">	
                                            ...
                                            <td class="a-center">
                                                <div>
                                                <router-link :to="'/customer/order/aftersalereturn/' + itemProduct.item_id"  >
                                                    <span style="font-size:1em">
                                                        {{ $t("message.order_return_request") }} 
                                                        <br>
                                                    </span>
                                                </router-link>
                                                </div>
                                                <!--
                                                <div>
                                                <router-link :to="'/customer/order/aftersaleexchange/' + itemProduct.item_id"  >
                                                    <span style="font-size:1em">
                                                        {{ $t("message.order_exchange") }} 
                                                        <br>
                                                    </span>
                                                </router-link>
                                                </div>
