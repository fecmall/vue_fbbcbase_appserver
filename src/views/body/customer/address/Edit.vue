                    ...
                    <ul>
                        ...
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    <div class="item-input">
                                        <input type="text" id='city-picker' class="city_picker"  />
                                    </div>
                                </div>
                            </div>
                        </li>	
                        ...
                        <li class="control">
                            <div class="change_password_label item-content">
                                <input v-model="address.is_default" name="address[is_default]"  title="Save in address book" id="address:is_default" class="address_is_default checkbox" type="checkbox">
                                <label for="address:is_default" style="display:inline;">{{ $t("message.is_default") }}</label>
                            </div>
                        </li>
                    </ul>	
                    <div class="clear"></div>
...
<script>
    ...
    export default {
        ...
        created: function(){
            ...
            if (this.address.state_city) {
                //$(".city_picker").val(this.address.state_city);
            }
        },
                ...
                $.ajax({
                    ...
                    success:function(reponseData, textStatus,request){
                        ...
                        if(reponseData.code == 1100003){
                            self.setLoginSuccessRedirectUrl('/customer/address');
                    ...
                    $.ajax({
                        ...
                        success:function(reponseData, textStatus,request){
                            ...
                            if(reponseData.code == 1100003){
                                ...
                                defaultCity = self.address.state_city
                            }
                            setTimeout(function(){
