...
import appCategoryAllBody from '../views/body/category/All.vue' //
...
import appCustomerOrderAfterSaleBody from '../views/body/customer/order/Aftersale.vue'
import appCustomerOrderAfterSaleReturnBody from '../views/body/customer/order/aftersale/Return.vue'
import appCustomerOrderAfterSaleReturnInfoBody from '../views/body/customer/order/aftersale/ReturnInfo.vue'
...
import appCheckoutOnepageAddressInitBody from '../views/body/checkout/onepage/AddressInit.vue' 
import appCheckoutOnepageAddressListBody from '../views/body/checkout/onepage/AddressList.vue' 
import appCheckoutOnepageAddressEditBody from '../views/body/checkout/onepage/AddressEdit.vue' 

import appCheckoutPaymentBody from '../views/body/checkout/Payment.vue' 
...
export default [
  ...
  {
    path: '/catalog/allcategory/list', // 分类
    components: {
      header: appHeader,
      body: appCategoryAllBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/customer/order/aftersale/:order_id',  // 用户订单
    components: {
      //header: appHeader,
      body: appCustomerOrderAfterSaleBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/customer/order/aftersalereturn/:item_id',  // 用户订单
    components: {
      //header: appHeader,
      body: appCustomerOrderAfterSaleReturnBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/customer/order/aftersalereturninfo/:item_id/:as_id',  // 用户订单
    components: {
      //header: appHeader,
      body: appCustomerOrderAfterSaleReturnInfoBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/checkout/onepage/addressinit',  // 货运地址列表
    components: {
      //header: appHeader,
      body: appCheckoutOnepageAddressInitBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/checkout/onepage/addresslist',  // 货运地址列表
    components: {
      //header: appHeader,
      body: appCheckoutOnepageAddressListBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/checkout/onepage/editaddress/:address_id',  // 货运地址列表
    components: {
      //header: appHeader,
      body: appCheckoutOnepageAddressEditBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/checkout/payment',  // 支付选择页面
    components: {
      //header: appHeader,
      body: appCheckoutPaymentBody,
      footer: appFooter,
      //leftmenu: leftMenu,
      //leftaccount: leftAccount
    }
  ...
  {
    path: '/checkout/payment/:orderIncrementId',  // 支付选择页面
    components: {
      //header: appHeader,
      body: appCheckoutPaymentBody,
      footer: appFooter,
